...
% 'demosaic', 'srgb', 'tone'
% remove the step of cropping area
...
if strcmp(input_stage, 'raw')
    ...
    % cropping area ( has been moved in
    % Load_Data_and_Metadata_from_DNG--2022.04.20)
...
if strcmp(input_stage,'demosaic')
    ...
    if ~ exist ('cam2xyz','var') || strcmp(cam2xyz, 'none') || isempty(cam2xyz)
        %xyz2cam9=metadata.ColorMatrix2; modified in 20220624
